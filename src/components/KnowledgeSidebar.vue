...
const props = defineProps({ selectedText:String, selectedMode:String, selectedQuestion:String, analysisResult:Object, analyzing:Boolean, results:Array, loading:Boolean, error:String, zhihuError:String, article:Object, engine:String })
...
const categoryResults=computed(() => (props.results || []).filter(i => category.value==='all' || i.category===category.value || category.value==='question' && i.url?.includes('/question/')))
</script>
